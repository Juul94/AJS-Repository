<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CheckOutDesign.ascx.cs" Inherits="CheckOut" %>

<asp:Repeater ID="Repeater_CheckOutDesign" runat="server" OnItemCommand="Repeater_CheckOutDesign_ItemCommand">
